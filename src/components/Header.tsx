        ...
        <div className="h-20 text-[#ff8c00] py-0 flex items-end justify-between mt-[10px] mb-[30px] pb-0">
          ...
          <Link to="/" className="flex items-center gap-3 group mb-0">
            <div className="relative">
              <Disc className="w-12 h-12 group-hover:animate-spin-slow transition-all pb-0 border-8 border-dashed border-vinyl-groove shadow-none rounded-full mb-[12px] text-primary bg-[#ff8c00]" />
              <div className="absolute inset-0 bg-retro-blue rounded-full scale-50 opacity-65 border-solid border-8 border-retro-cream mb-[12px] text-accent" />
            </div>
            <div className="flex flex-col">
              <span className="font-bold tracking-wider text-5xl font-sans text-slate-700">
                orangeblue
              </span>
